...
/****** Object:  Database [mobileapp]    Script Date: 11/13/2023 11:40:15 PM ******/
CREATE DATABASE [mobileapp]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'mobileapp', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\mobileapp.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'mobileapp_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\mobileapp_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [mobileapp] SET RECOVERY FULL 
GO
...
ALTER DATABASE [mobileapp] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [mobileapp] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [mobileapp] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [mobileapp] SET QUERY_STORE = OFF
GO
